...
return function(ContainerConfigurator $container): void {
    ...
    $services->set('commerce_weavers_sylius_tpay.visa_mobile.twig.component.gateway_configuration', GatewayConfigurationComponent::class)
        ->args([
        ...
        ->tag(
            ...
            [
                'key' => 'cw_tpay_admin:visa_mobile:gateway_configuration',
