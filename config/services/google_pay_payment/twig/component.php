...
return function(ContainerConfigurator $container): void {
    ...
    $services->set('commerce_weavers_sylius_tpay.google_pay.twig.component.gateway_configuration', GatewayConfigurationComponent::class)
        ->args([
        ...
        ->tag(
            ...
            [
                'key' => 'cw_tpay_admin:google_pay:gateway_configuration',
