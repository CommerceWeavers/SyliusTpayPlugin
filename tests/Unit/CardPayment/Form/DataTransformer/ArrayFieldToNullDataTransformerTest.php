...
final class ArrayFieldToNullDataTransformerTest extends TestCase
{
    ...
    public function test_it_returns_an_empty_string_when_trying_to_reverse_transform_a_non_array(): void
    {
        ...
        $this->assertSame(null, $dataTransformer->reverseTransform(null));
        $this->assertSame(null, $dataTransformer->reverseTransform(true));
        $this->assertSame(null, $dataTransformer->reverseTransform('string'));
        $this->assertSame(null, $dataTransformer->reverseTransform(1));
        $this->assertSame(null, $dataTransformer->reverseTransform([]));
    }
    ...
    {
        return new ArrayFieldToNullDataTransformer();
    }
}
