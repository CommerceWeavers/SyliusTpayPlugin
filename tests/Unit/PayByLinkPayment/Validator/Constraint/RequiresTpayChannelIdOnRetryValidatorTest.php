...
use CommerceWeavers\SyliusTpayPlugin\PayByLinkPayment\Validator\Constraint\RequiresTpayChannelIdOnRetryValidator;
...
final class RequiresTpayChannelIdOnRetryValidatorTest extends ConstraintValidatorTestCase
{
    use ProphecyTrait;
    ...
    public function test_it_does_nothing_if_value_is_not_an_array(): void
    {
        ...
        $this->validator->validate('not-an-array', new RequiresTpayChannelIdOnRetry());
    ...
    public function test_it_does_nothing_if_factory_name_is_not_tpay_pbl(): void
    {
        ...
        $this->validator->validate([], new RequiresTpayChannelIdOnRetry());

        $this->assertNoViolation();
    }

    public function test_it_does_nothing_if_order_has_no_last_new_payment(): void
    {
        $this->initializeContextWithFactoryName('tpay_pbl');

        $this->order->getLastNewPayment()->willReturn(null);
    ...
    public function test_it_builds_violation_if_tpay_channel_id_is_empty_for_tpay_pbl(): void
    {
        ...
        $this->validator->validate(['tpay_channel_id' => ''], new RequiresTpayChannelIdOnRetry());
    ...
    public function test_it_does_nothing_if_tpay_channel_id_is_provided_for_tpay_pbl(): void
    {
        ...
        $this->validator->validate(['tpay_channel_id' => '123'], new RequiresTpayChannelIdOnRetry());
    ...
    protected function createValidator(): RequiresTpayChannelIdOnRetryValidator
    {
        return new RequiresTpayChannelIdOnRetryValidator();
    }
    ...
    private function initializeContextWithFactoryName(?string $factoryName): void
    {
        ...
        $this->order->getLastNewPayment()->willReturn($this->payment->reveal());
