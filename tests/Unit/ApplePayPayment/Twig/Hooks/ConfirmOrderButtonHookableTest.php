...
namespace CommerceWeavers\SyliusTpayPlugin\Tests\Unit\ApplePayPayment\Twig\Hooks;

use CommerceWeavers\SyliusTpayPlugin\ApplePayPayment\Payum\Factory\GatewayFactory;
use CommerceWeavers\SyliusTpayPlugin\ApplePayPayment\Twig\Hooks\ConfirmOrderButtonHookable;
...
final class ConfirmOrderButtonHookableTest extends TestCase
{
    ...
    public function test_it_returns_empty_string_when_payment_method_is_apple_pay(): void
    {
    ...
    public function test_it_delegates_to_decorated_renderer_when_payment_method_is_not_apple_pay(): void
    {
        $hookable = $this->createHookable('sylius_shop.checkout.complete.content.form', 'navigation');
